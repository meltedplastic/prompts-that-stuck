...
Some prompts also have a **Claude Code** version — a one-line install that makes it automatic. Look for the ⚡ icon.
...
[LinkedIn](https://www.linkedin.com/in/samportillo/) · [X](https://x.com/___sampo___)
